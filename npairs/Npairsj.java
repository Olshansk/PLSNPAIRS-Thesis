...
//		}
		...
		double s = tTime - (hr * 3600) - (min * 60) ;
			output.print("Total time running NPAIRS analysis: " + hr + 
					" h " + min + " min ");
			//Alan:
			System.out.println("Total time running NPAIRS analysis: " + hr + 
					" h " + min + " min ");   
...
//				}
	...
	private void runSplitAnalyses() throws NpairsjException, IOException {
		...
		try
		{	
			ObjectOutput out = new ObjectOutputStream(new FileOutputStream("fullDataAnalysis.ser"));
		...
		try
		{	
			ObjectOutput out = new ObjectOutputStream(new FileOutputStream("setupParams.ser"));
		...
		*/
		...
		for(int i = 0; i < numSlaves; i++){
			...
			if(i == (numSlaves - 1)){
				for(int j=0 ; j < (numSamples - i*numPerSlave); j++){
					if(j == 0){
						outString = Integer.toString(i*numPerSlave + j);
					}
					else{
						outString = outString + "_" + Integer.toString(i*numPerSlave + j);
					}
				}
			}
			else{
				for(int j=0 ; j < numPerSlave; j++){
					if(j == 0){
						outString = Integer.toString(i*numPerSlave + j);
					}
					else{
		...
		for(int i = 0; i < numSlaves; i++){
	        ...
	        try {
	        	avgCVScoresTest = avgCVScoresTest.plus((Matrix)  ois.readObject());
	        ...
	        FileInputStream fis2 = new FileInputStream("out_npairsj_ser/avgCVScoresTrain_" + j);
	        ObjectInputStream ois2 = new ObjectInputStream(fis2);
	       
	        try {
	        	avgCVScoresTrain = avgCVScoresTrain.plus((Matrix)  ois2.readObject());
	        ...
	        FileInputStream fis3 = new FileInputStream("out_npairsj_ser/avgNoisePattern_" + j);
	        ObjectInputStream ois3 = new ObjectInputStream(fis3);
	        FileInputStream fis4 = new FileInputStream("out_npairsj_ser/avgSpatialPattern_" + j);
	        ObjectInputStream ois4 = new ObjectInputStream(fis4);
	        FileInputStream fis5 = new FileInputStream("out_npairsj_ser/avgZScorePattern_" + j);
	        ...
	        if(i == 0){
	        	...
	        	try {
		        	avgNoisePattern = avgNoisePattern.plus((Matrix)  ois3.readObject());
	        	...
	        	try {
		        	avgSpatialPattern = avgSpatialPattern.plus((Matrix)  ois4.readObject());
	        	...
	        	try {
		        	avgZScorePattern = avgZScorePattern.plus((Matrix)  ois5.readObject());
	        ...
	        FileInputStream fis6 = new FileInputStream("out_npairsj_ser/ppTrueClass_" + j);
	        ...
	        ois6.close();
	        FileInputStream fis7 = new FileInputStream("out_npairsj_ser/sqrdPredError_" + j);
	        ...
	        FileInputStream fis8 = new FileInputStream("out_npairsj_ser/predClass_" + j);
	        ...
	        FileInputStream fis9 = new FileInputStream("out_npairsj_ser/correctPred_" + j);
	        ...
	        FileInputStream fis10 = new FileInputStream("out_npairsj_ser/ppAllClasses_" + j);
	        ...
	        FileInputStream fis11 = new FileInputStream("out_npairsj_ser/r2_" + j);
	        ...
	        FileInputStream fis12 = new FileInputStream("out_npairsj_ser/corrCoeffs_" + j);
	        ...
	        FileInputStream fis13 = new FileInputStream("out_npairsj_ser/noisePattStdDev_" + j);
		...
		for (int splitNum = 0; splitNum < numSamples; ++splitNum) {
			...
			corrCoeffs.setRow(splitNum, corrCoeffs_temp[index].getRow(splitNum));
			noisePattStdDev.setRow(splitNum, noisePattStdDev_temp[index].getRow(splitNum));
	...
	private void computePredStats2(int numAnalyses, 
			int index) throws NpairsjException {
